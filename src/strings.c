...
const u8 gText_ThisIsAPokemon[] = _("This is the fossil POKéMON Omanyte.{PAUSE 96}\p");
...
const u8 gText_HelixEggHatchTomorrow[] = _("This egg will hatch\ntomorrow!");
...
const u8 gText_HelixBredEgg[] = _("Who knows what this will\nhatch into?");
