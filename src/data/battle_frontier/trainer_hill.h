            ...
            [1] =
            {
                ...
                .mons =
                {
                    [0] =
                    {
                        ...
                        .speedEV = 252,
                        .otId = TRAINER_HILL_OTID,
                        .hpIV = MAX_LEGACY_PER_STAT_IVS,
                        .attackIV = MAX_LEGACY_PER_STAT_IVS,
                        .defenseIV = MAX_LEGACY_PER_STAT_IVS,
                        .speedIV = MAX_LEGACY_PER_STAT_IVS,
                        .spAttackIV = MAX_LEGACY_PER_STAT_IVS,
                        .spDefenseIV = MAX_LEGACY_PER_STAT_IVS,
                        .abilityNum = 0,
                        .personality = 0xCB,
                        .nickname = _("SKITTY"),
                        .friendship = MAX_FRIENDSHIP,
